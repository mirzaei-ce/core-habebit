Habebit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/habebit/files/Habebit/habebit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Habebit
...
New/changed settings (command-line or habebit.conf file)
--------------------------------------------------------
