Habebit Core version 0.9.4 is now available from:

  https://habebit.org/bin/0.9.4/
...
this update is incompatible with the Habebit system and could lead to consensus
forks.

Habebit Core released binaries from https://habebit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~habebit/+archive/ubuntu/habebit
- A third-party or self-compiled Habebit Core

upgrade to Habebit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
