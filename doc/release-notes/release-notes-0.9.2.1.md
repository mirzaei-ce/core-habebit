Habebit Core version 0.9.2.1 is now available from:

  https://habebit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HBT to 0.01 HBT
...
- Fix "Start habebit on system login"
