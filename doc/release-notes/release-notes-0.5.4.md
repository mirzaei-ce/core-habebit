Habebit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/habebit/files/Habebit/habebit-0.5.4/
...
http://gitorious.org/habebit/habebitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Habebit-Qt notifications under Growl 1.3.
Increase required age of Habebit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHabebit properly when installing Habebit-Qt over it. (Windows)
