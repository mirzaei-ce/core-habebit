Download URL: https://sourceforge.net/projects/habebit/files/Habebit/habebit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 HBT fee schedule (users still pay 0.01 HBT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #habebit00 - #habebit99
