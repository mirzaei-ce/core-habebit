...
unlocked to sign the Habebit-Qt.app bundle.
...
allowing somebody to distribute a Habebit-Qt.app or habebit-qt-setup.exe with a valid
...
that the habebit-qt.exe file inside the installer had not been tampered with.
