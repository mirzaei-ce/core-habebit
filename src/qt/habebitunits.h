...
#ifndef HABEBIT_QT_HABEBITUNITS_H
#define HABEBIT_QT_HABEBITUNITS_H
...
/** Habebit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HabebitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HabebitUnits(QObject *parent);

    /** Habebit units.
      @note Source: https://en.habebit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        HBT,
...
typedef HabebitUnits::Unit HabebitUnit;

#endif // HABEBIT_QT_HABEBITUNITS_H
