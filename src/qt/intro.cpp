...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/habebit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Habebit Core"),
     ...
     * override -datadir in the habebit.conf file in the default data directory
     * (to be consistent with habebitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
