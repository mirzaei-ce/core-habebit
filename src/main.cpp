...
#if defined(NDEBUG)
# error "Habebit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Habebit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s HBT additional fees, %d delta bytes\n",
