...
#ifndef HABEBIT_TEST_SCRIPTNUM10_H
#define HABEBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Habebit Core 0.10.0, for cross-comparison.
 */
public:
