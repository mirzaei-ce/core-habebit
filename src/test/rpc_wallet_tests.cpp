...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CHabebitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CHabebitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CHabebitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CHabebitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CHabebitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CHabebitAddress(arr[0].get_str()).Get() == demoAddress.Get());
